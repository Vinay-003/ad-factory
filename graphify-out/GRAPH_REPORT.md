...
## Corpus Check
- 17 files · ~897,575 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 244 nodes · 517 edges · 11 communities detected
...
8. `main()` - 10 edges
9. `run_cmd()` - 9 edges
10. `normalize_generated_copy()` - 9 edges
...
Cohesion: 0.08
Nodes (57): api_defaults(), api_file_content(), api_opencode_catalog(), api_run(), api_run_execute(), api_runs(), assembler_language_mode(), build_copy_requirements() (+49 more)
...
Cohesion: 0.2
Nodes (16): build_generation_context(), build_prompt(), call_http_fallback(), default_product_path(), ensure_list_of_strings(), main(), merge_product_directives(), normalize_canonical() (+8 more)
...
- **Why does `write_text()` connect `Community 2` to `Community 0`, `Community 1`, `Community 3`, `Community 6`, `Community 7`, `Community 8`, `Community 10`?**
